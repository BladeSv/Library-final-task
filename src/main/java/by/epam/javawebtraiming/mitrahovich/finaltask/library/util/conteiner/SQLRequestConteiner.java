...
public class SQLRequestConteiner {
	...
	public static final String USER_BOOK_BY_ID = "SELECT id_book, book.title AS book_title, annotation,book.id_autor, autor.name, autor.surname, genre.id_genre, genre.title AS genre_title FROM book INNER JOIN autor ON autor.id_autor=book.id_autor\r\n"
	...
	public static final String USER_GET_ALL_FREE_BOOK = " SELECT id_book, book.title AS book_title, annotation,book.id_autor, autor.name, autor.surname, genre.id_genre, genre.title AS genre_title\r\n"
